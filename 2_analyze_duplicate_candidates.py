...
ALTER COLUMN `entity_name` COMMENT 'The name of the entity (table) being analyzed (e.g., "patient", "location"). Use this to identify which data set the data is derived from';
""")
spark.sql(f"""
ALTER TABLE {analysis_table_name}
